...
*/
    ...
    /**
* 302 FOUND - This response code means that the URI
...
*/
    NotModified = 304,
    /**
* 305 USE PROXY - Defined in a previous version of the HTTP specification to
...
* to get the requested resource at another URI with same method that was used in the prior request.
