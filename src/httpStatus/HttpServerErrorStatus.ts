...
* The webmaster must also take care about the
...
*/
    ...
    /**
* 504 GATEWAY TIMEOUT - This error response is given when the server is acting as
...
*/
    GatewayTimeout = 504,
    /**
* 505 HTTP VERSION NOT SUPPORTED - The HTTP version used in
...
*/
    ...
    /**
* 507 INSUFFICIENT STORAGE - The method could not be performed on the resource because the server is
...
*/
    NotExtended = 510,
    /**
* 511 NETWORK AUTHENTICATION REQUIRED - The 511 status code indicates that
